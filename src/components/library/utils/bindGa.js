      ...
      if (typeof ga === 'function') {
        try {
          if (
            ...
            args[0] &&
            args[0].target &&
            (args[0].target.getAttribute('data-ga4') ||
              args[0].currentTarget.getAttribute('data-ga4'))
          ) {
            analyticsWrapper(
              'ga4',
              ...JSON.parse(
        ...
        if (typeof args === 'object' && args[0] && args[0].target) {
          ...
          if (
            ...
            if (
              ...
              if (typeof window !== 'undefined' && window.categoryForGA) {
            ...
            if (
              ...
              if (gaData[2] && gaData[2].indexOf('/') > -1) {
