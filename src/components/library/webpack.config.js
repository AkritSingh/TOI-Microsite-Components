...
const SRC_DIRS = [resolvePath('atoms'), resolvePath('molecules'), resolvePath('organism'), resolvePath('pages'), resolvePath('helpers'), resolvePath('contexts'), resolvePath('templates'), resolvePath('uiHelpers'), resolvePath('utils'),  resolvePath('scss'), resolvePath('styles')]
